    ...
    <div style={{ minHeight: "100vh", background: "var(--background)", color: "var(--foreground)" }}>
      ...
      <div style={{ maxWidth: "720px", margin: "0 auto", padding: "2.5rem 1.5rem 6rem" }}>
        ...
        <div style={{ lineHeight: 1.8, fontSize: "0.95rem", color: "color-mix(in srgb, var(--foreground) 75%, transparent)" }}>
          ...
          <p>By accessing or using Ascentra ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, please do not use the Service.</p>

          <h2 style={{ fontSize: "1.2rem", fontWeight: 700, color: "var(--foreground)", marginTop: "2rem" }}>2. Description of Service</h2>
          <p>Ascentra is an online financial calculator and planning tool. The Service provides income estimation, expense analysis, financial health scoring, and related features.</p>
          ...
          <ul style={{ paddingLeft: "1.5rem" }}>
            ...
            <li>Ascentra does not guarantee any particular financial outcome.</li>
          ...
          <p>All content, design, code, and features of Ascentra are the property of Ascentra and are protected by applicable intellectual property laws.</p>

          <h2 style={{ fontSize: "1.2rem", fontWeight: 700, color: "var(--foreground)", marginTop: "2rem" }}>8. Limitation of Liability</h2>
          <p>To the maximum extent permitted by law, Ascentra and its creators shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the Service.</p>
