...
export function generateICS(): string {
  ...
  return [
    "BEGIN:VCALENDAR",
    "VERSION:2.0",
    "PRODID:-//Ascentra//Monthly Check-In//EN",
    "BEGIN:VEVENT",
    `DTSTART:${fmtDate(dtStart)}`,
    `DTEND:${fmtDate(new Date(dtStart.getTime() + 30 * 60000))}`,
    "RRULE:FREQ=MONTHLY;BYMONTHDAY=1",
    "SUMMARY:Ascentra Monthly Check-In",
    "DESCRIPTION:Time to update your Ascentra numbers! Review expenses\\, check your fragility score\\, and adjust your plan.",
